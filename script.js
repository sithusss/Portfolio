...
window.onload = function() {
    loadContent('about.html', 'container_about');
    loadContent('project.html', 'container_projects');
    loadContent('portfolio.html', 'container_portfolio');
    loadContent('contacts.html', 'container_contact');
    };
